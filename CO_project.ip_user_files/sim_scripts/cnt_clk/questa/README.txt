...
#
# Generated by export_simulation on Tue Jun 04 17:46:33 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './cnt_clk.sh' script.

./cnt_clk.sh -reset_run
...
./cnt_clk.sh -noclean_files

For more information on the script, please type './cnt_clk.sh -help'.
